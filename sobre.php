  ...
  <body>
      <div class="container">
        ...
        <div class="paragrafo">
            ...
            <p>Nosso centro de distribuição fica em <a href="https://www.google.com.br/maps?q=Jacarezinho" target="_blank">Jacarezinho, no Paraná</a>. De lá, saem 48 aviões que
            distribuem nossos produtos às casas do mundo todo. Nosso centro de distribuição:</p>

            <!-- Img Centro de Distribuição -->
            <figure id="centro-distribuicao">
              <img src="img/centro-distribuicao.png" alt="Logo da Mirror Fashion">
              <h3>Centro de distribuição da Mirror Fashion</h3>
            </figure>
            ...
            <p>A fundação em <?php print date("Y") ; ?> ocorreu no momento da descoberta econônica do interior do Paraná. A
